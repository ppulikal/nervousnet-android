...
public class ConnectivityData implements SensorDataImpl {
	...
	public ConnectivityData(Long id, Long TimeStamp, Boolean isConnected, Integer networkType, Boolean isRoaming,
			String wifiHashId, Integer wifiStrength, String mobileHashId, long Volatility, Boolean ShareFlag) {
		this.id = id;
